...
namespace Core.EventSystem
{
    public class EventManager
    {
        ...
        public void Start_Listen_To ( string _eventName, EventHandler _event )
        {
            if ( !Events.TryGetValue ( _eventName, out EventHandler thisEvent ) )
            {
        ...
        /// <param name="_eventName">The name of the event</param>
        /// <returns></returns>
        public EventHandler Get_Event ( string _eventName )
        {
        ...
        {
            Instance.Events = new Dictionary<string, EventHandler> ();
        }
    }
}
